...
#
# Note:the running time depends on how many samples you need for the MCMC
###################################################
...
#################################
#plt.figure()
#plt.plot(z_SS, DL_SS/Ell_DL_LCDM(z_SS, [0.3, 0.7]) -1 , '.')
#plt.plot(z_SS, )
#plt.show()
...
###########################################
# for a beta prior uncomment the lines
#MEDIAN = 0.3
#b=100
...
def log_prior_Omega(Omega):
    if (Omega<0.0) or (Omega>1.0):
        ...
        result = 0 #stats.beta.logpdf(Omega,a,b)
